...
function insert(dados) {
    ...
    let sql = `INSERT INTO pedidoProdutoCliente (idproduto, id_cliente) VALUES (${idproduto}, ${idpedido}, ${id_cliente}) RETURNING id`
...
function deleteById(ids) {
    ...
    return queryPromiseReturn(`DELETE FROM pedidoProdutoCliente WHERE id IN (${idsDelete})`)
}
