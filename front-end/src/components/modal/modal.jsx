              ...
              {metodoPagamento === "boleto" && (
                <div className="flex flex-col gap-5 text-base border-solid border border-black rounded-md p-2">
                  ...
                  <span>
                    ...
                    Imprima e pague no banco ou pague pela internet utilizando o
              ...
              {metodoPagamento === "pix" && (
                <div className="flex flex-col gap-4">
                  <div className="flex gap-2">
                    ...
                    <div className="flex gap-2">
                      ...
                      <span className="font-bold">
                        {(precoProduto[0]?.preco * 0.9).toLocaleString(
                          "pt-BR",
                          {
                            style: "currency",
                            currency: "BRL",
                  ...
                  <span>
                    ...
                    finalização da compra, a gente explica direitinho como pagar
                    com Pix.
                  </span>
                </div>
              )}
